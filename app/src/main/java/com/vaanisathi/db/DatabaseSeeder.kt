...
object DatabaseSeeder {
    ...
    suspend fun seed(dao: PhraseDao) {
        ...
        val classroomPhrases = listOf(
            ...
            // Additional phrases for better ASR coverage
            FLNPhrase(phraseCode="CLS_011", domain="oral_language",
                hindiText="पानी लाओ",
                santhaliOlChiki="ᱫᱟᱜ ᱟᱠᱟᱱᱟ",
                santhaliRoman="Dag akana",
                audioFilename="cls_011_sat.mp3",
                gradeLevel=1, nipunCode="NB-OL-G1-11",
                context="classroom_mgmt", validated=false),

            FLNPhrase(phraseCode="CLS_012", domain="oral_language",
                hindiText="अच्छा किया",
                santhaliOlChiki="ᱟᱞᱚᱢ ᱠᱟᱢᱤ",
                santhaliRoman="Alom kami",
                audioFilename="cls_012_sat.mp3",
                gradeLevel=1, nipunCode="NB-OL-G1-12",
                context="praise", validated=false),

            FLNPhrase(phraseCode="CLS_013", domain="oral_language",
                hindiText="ध्यान दो",
                santhaliOlChiki="ᱢᱚᱱ ᱫᱮ",
                santhaliRoman="Mon de",
                audioFilename="cls_013_sat.mp3",
                gradeLevel=1, nipunCode="NB-OL-G1-13",
                context="instruction", validated=false),

            FLNPhrase(phraseCode="CLS_014", domain="oral_language",
                hindiText="हाथ उठाओ",
                santhaliOlChiki="ᱵᱟᱦᱟ ᱫᱮ",
                santhaliRoman="Baha de",
                audioFilename="cls_014_sat.mp3",
                gradeLevel=1, nipunCode="NB-OL-G1-14",
                context="instruction", validated=false),

            FLNPhrase(phraseCode="CLS_015", domain="oral_language",
                hindiText="पढ़ो",
                santhaliOlChiki="ᱯᱚᱲᱟᱣ",
                santhaliRoman="Porhaw",
                audioFilename="cls_015_sat.mp3",
                gradeLevel=1, nipunCode="NB-OL-G1-15",
                context="instruction", validated=false),

            FLNPhrase(phraseCode="CLS_016", domain="oral_language",
                hindiText="लिखो",
                santhaliOlChiki="ᱞᱤᱠᱷᱟᱣ",
                santhaliRoman="Likhaw",
                audioFilename="cls_016_sat.mp3",
                gradeLevel=1, nipunCode="NB-OL-G1-16",
                context="instruction", validated=false),

            FLNPhrase(phraseCode="PHN_001", domain="phonological",
                hindiText="एक बार और",
                santhaliOlChiki="ᱢᱤᱛ ᱵᱟᱨ ᱛᱮ",
                santhaliRoman="Mit bar te",
                audioFilename="phn_001_sat.mp3",
                gradeLevel=1, nipunCode="NB-PH-G1-01",
                context="instruction", validated=false),

            FLNPhrase(phraseCode="NUM_001", domain="numeracy",
                hindiText="गिनो",
                santhaliOlChiki="ᱜᱤᱱᱛᱤ",
                santhaliRoman="Ginti",
                audioFilename="num_p01_sat.mp3",
                gradeLevel=1, nipunCode="NB-NUM-G1-01",
                context="instruction", validated=false)
        )
